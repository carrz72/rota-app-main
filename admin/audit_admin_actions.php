...
?><!doctype html>
<html><head><meta charset="utf-8"><title>Audit Admin Action</title><link rel="stylesheet" href="../css/admin_dashboard.css"></head><body>
<div class="admin-container">
    ...
    <?php if ($action): ?>
        ...
        <p>
            <a href="../functions/get_audit_admin_action.php?id=<?php echo h($action['id']); ?>">Download signed proof (JSON)</a>
        </p>
    <?php else: ?>
