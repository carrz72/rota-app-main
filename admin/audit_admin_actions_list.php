    ...
    <div class="admin-container">
        ...
        <form id="exportForm" method="post" action="../functions/export_audit_admin_actions.php">
            ...
            <div style="margin-top:12px;">
                <label><input type="checkbox" name="include_archives" value="1"> Include archived blobs (base64) in
                    export (large)</label>
            </div>
            <div style="margin-top:12px;">
        ...
        <div style="margin-top:12px;">
            ...
            <?php for ($i = 1; $i <= $pages; $i++): ?>
                <?php if ($i == $page): ?><strong><?php echo $i; ?></strong><?php else: ?><a
                        href="?page=<?php echo $i; ?>"><?php echo $i; ?></a><?php endif; ?>
            <?php endfor; ?>
        </div>
    </div>
</body>
